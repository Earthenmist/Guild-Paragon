...
function Applicants:OnEnable()
    self.loading = true
    self.state = "waiting"
    GP:RegisterOptionalEvent(self, "CLUB_FINDER_RECRUITS_UPDATED", "OnRecruitsUpdated")
    GP:RegisterOptionalEvent(self, "CLUB_FINDER_APPLICATIONS_UPDATED", "OnApplicationsUpdated")
