...
function UpcomingDates:OnEnable()
    GP:RegisterOptionalEvent(self, "CALENDAR_NEW_EVENT")
    GP:RegisterOptionalEvent(self, "CALENDAR_UPDATE_ERROR", "CalendarError")
    GP:RegisterOptionalEvent(self, "CALENDAR_UPDATE_ERROR_WITH_COUNT", "CalendarError")
    GP:RegisterOptionalEvent(self, "CALENDAR_UPDATE_ERROR_WITH_PLAYER_NAME", "CalendarError")
    GP:RegisterOptionalEvent(self, "CALENDAR_CLOSE_EVENT")
end
