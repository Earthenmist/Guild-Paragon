...
local COMMANDS = {
    ...
    { "/gp housingscan", GP.L["Scan guild House Finder subdivisions for plot owners."] },
    { "/gp housingdebug", GP.L["Print the last housing scan summary and unmatched owner samples."] },
    { "/gp monitor", GP.L["Start, stop, inspect or export local multi-session performance recording."] },
...
function HelpTab:Build(parent)
    ...
    if not messagesRegistered then
        ...
        HelpTab:RegisterMessage("GuildParagon_RosterScanned", GP:MonitorWrap("listener.help", debouncedDirtyRefresh))
