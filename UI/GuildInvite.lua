...
function Invite:Open(parent)
    ...
    if not dialog then
        ...
        description:SetText(GP.L[GP:IsForeverClient()
            and "Enter the character's full name to invite to your guild (FirstName LastName):"
            or "Enter the character name to invite to your guild (Name-Realm for another realm):"])
